...
> **P00 Dashboard** — 四篇十六章 · 50 个工具 · 案例驱动的实战训练  
> 完全本地运行 · 隐私安全 · 适合新手与进阶学习者

一个**无需注册、无需联网（离线可用）**的新闻素养实战学习仪表盘。所有数据仅存储在你的浏览器本地，安全、私密、随时可导出备份。

📖 **教师请从这里开始**：查看 **[教学指南（TEACHING.md）](./TEACHING.md)** ——配套《新闻传播AI应用教程》的教师用书，含教学硬标准、16 周排课表、4 次工作坊方案与评价量规。

---

## 📚 课程结构（配套教材）

本工具箱是**《新闻传播AI应用教程》**（中国人民大学出版社，马琪昌、毛良斌 著）的**配套在线实验平台**，工具目录与教材**四篇十六章**逐章对齐：

- **篇Ⅰ 认知篇**（建立认知坐标与对话能力）→ 篇Ⅱ **方法篇**（以数据为对象的方法实践）→ 篇Ⅲ **实操篇**（以新闻产品为对象的工具实操）→ 篇Ⅳ **治理篇**（治理/素养/系统/未来）
- **50 个工具**按章归属，其中：
  - **20 个官方实验工具**（附录A，平台内以 ★ 标记）：**Tier 1 × 12** 为教材正文实验直接使用的必做工具；**Tier 2 × 8** 为实验使用或延伸推荐的选做工具；
  - **30 个拓展工具**（无 ★ 标记），供课后自学与差异化教学。
- 第1、3章为理论章（无实验工具）；附录C 配套通识工具 P48 归入篇Ⅳ 分组末尾的「全书通识」单元。
...
- **系统学习**：学习模块对齐教材四篇十六章，覆盖 50 个实用新闻工具
...
flowchart TD
    ...
    Tab1 -->|📚 学习模块| Modules[浏览四篇十六章 + 50 工具]
...
与《新闻传播AI应用教程》四篇十六章对齐的 **50 个工具** 总览：

- 按**篇**分组（篇Ⅰ—篇Ⅳ 四个分组，含篇章副标题），章卡片显示章号、章名、工具分级摘要与一句话教学定位
- **★ 标记**为教材官方实验工具（Tier 1 正文实验 / Tier 2 实验延伸），无标记为拓展工具
- 点击工具名称可直接跳转对应工具页面
- **✓ 已用** 表示你已通过该工具产生过学习记录
- **↺ 已恢复** 表示该进度来自任务恢复
